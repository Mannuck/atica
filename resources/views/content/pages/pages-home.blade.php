...
<h4 class="py-3 breadcrumb-wrapper mb-4">
  <span class="text-muted fw-light">Panel /</span> Administrativo
</h4>
...
<div class="row gy-4">
  ...
  <div class="col-xl-6 col-12">
    <div class="card">
      <div class="card-header header-elements">
        <h5 class="card-title mb-0">Ultimas estadisticas</h5>
  ...
  <div class="col-lg-6 col-12">
    <div class="card">
      <div class="card-header">
        <h5 class="card-title mb-0">Estadistica radar</h5>
      </div>
      <div class="card-body">
  ...
  <div class="col-lg-6 col-12">
    <div class="card">
      <div class="card-header header-elements">
        <h5 class="card-title mb-0">Estadistica mensual</h5>
  ...
  <div class="col-lg-4 col-12">
    <div class="card">
      <h5 class="card-header">Usuarios por dispositivos</h5>
      <div class="card-body">
  ...
  <div class="col-lg-8 col-12">
    <div class="card">
      <div class="card-header flex-nowrap header-elements">
        <h5 class="card-title mb-0">Datos de producto nuevos</h5>
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header header-elements">
        <h5 class="card-title mb-0">ciencia de datos</h5>
